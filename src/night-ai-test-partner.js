      ...
      messages:[
        {
          ...
          content:[
            ...
            'Это НЕ реальный человек, НЕ голос реального партнёра, НЕ его или её согласие и НЕ прогноз её фактического поведения.',
            'Опирайся только на переданный агрегированный контекст отношений и историю приложения.',
